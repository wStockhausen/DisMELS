/*
 * SimplePelagicLHSParametersCustomizer.java
 *
 ...
 */
public class SimplePelagicLHSParametersCustomizer extends LifeStageParametersCustomizer {

    private SimplePelagicLHSParameters parameters;
    private boolean b;
    private double d;
    private int i;

    /**
     * Creates new customizer SimplePelagicLHSParametersCustomizer
     */
    public SimplePelagicLHSParametersCustomizer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Vertical diffusion (m^2/s)");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jtfVSS)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jtfVertDiff))
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel3Layout.createSequentialGroup()
                        ...
                        .add(jtfMinSize, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 61, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jLabel8))
                    .add(jPanel3Layout.createSequentialGroup()
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(drNightTime, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 315, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
    ...
    public void setObject(Object bean) {
        if (bean instanceof SimplePelagicLHSParameters) {
            setParameters((SimplePelagicLHSParameters) bean);
        }
    }

    private void setParameters(LifeStageParametersInterface newParams) {
        if (newParams instanceof SimplePelagicLHSParameters) {
            parameters = (SimplePelagicLHSParameters) newParams;
