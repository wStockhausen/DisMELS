 ...
 */
public class SimpleSettlerLHSParametersBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class , SimpleSettlerLHSParametersCustomizer.class ); // NOI18N
        beanDescriptor.setDisplayName ( "SimpleSettlerLHSParameters" );//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_IBMFunctionCategories] = new PropertyDescriptor ( "IBMFunctionCategories", wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "getIBMFunctionCategories", null ); // NOI18N
            properties[PROPERTY_IBMParameterNames] = new PropertyDescriptor ( "IBMParameterNames", wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "getIBMParameterNames", null ); // NOI18N
            properties[PROPERTY_keys] = new PropertyDescriptor ( "keys", wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "getKeys", null ); // NOI18N
            properties[PROPERTY_typeName] = new PropertyDescriptor ( "typeName", wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "getTypeName", "setTypeName" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_clone0] = new MethodDescriptor(wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class.getMethod("clone", new Class[] {})); // NOI18N
            methods[METHOD_clone0].setDisplayName ( "" );
            methods[METHOD_createInstance1] = new MethodDescriptor(wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class.getMethod("createInstance", new Class[] {java.lang.String[].class})); // NOI18N
            ...
            methods[METHOD_getIBMFunctionNamesByCategory3] = new MethodDescriptor(wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class.getMethod("getIBMFunctionNamesByCategory", new Class[] {java.lang.String.class})); // NOI18N
            ...
            methods[METHOD_setValue22] = new MethodDescriptor(wts.models.DisMELS.LHS.Settler.SimpleSettlerLHSParameters.class.getMethod("setValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
