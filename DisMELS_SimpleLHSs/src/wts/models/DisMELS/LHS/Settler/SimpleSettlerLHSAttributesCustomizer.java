/*
 * SimpleSettlerLHSAttributesCustomizer.java
 *
 ...
 */
public class SimpleSettlerLHSAttributesCustomizer extends AttributesCustomizer {

    private boolean showHorizPos = true;
    private boolean showVertPos = true;
    
    private SimpleSettlerLHSAttributes attributes = null;
//                                    new SimpleSettlerLHSAttributes("");
    
    /**
     * Creates new customizer SimpleSettlerLHSAttributesCustomizer
     */
    public SimpleSettlerLHSAttributesCustomizer() {
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public void setObject(Object bean) {
        if (bean instanceof SimpleSettlerLHSAttributes) {
            setAttributes((SimpleSettlerLHSAttributes) bean);
        }
    }
    ...
    public void setAttributes(LifeStageAttributesInterface newAtts) {
        if (newAtts instanceof SimpleSettlerLHSAttributes) {
            attributes = (SimpleSettlerLHSAttributes) newAtts;
            Boolean b = null;
            Double d = null;
            Integer i = null;
