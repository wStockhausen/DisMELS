/**
 * LagrangianParticle2D.java
 *
 * Created on November 8, 2019
 *
 * Revisions:
 * 20191109: 1. Copied from LagrangianParticle.
 */
 ...
 */
public class LagrangianParticle2D implements Cloneable {
     ...
     */
    public static int NFV = 6;
    
    public static int IXGRD = 0;
    public static int IYGRD = 1;
    public static int IXRHS = 2;
    public static int IYRHS = 3;
    public static int IU    = 4;
    public static int IV    = 5;
    
    private static LagrangianParticleTracker2D lpt;
    ...
    /** logger for class */
    private static final Logger logger = Logger.getLogger(LagrangianParticle2D.class.getName());
    
    /** Creates a new instance of LagrangianParticle */
    public LagrangianParticle2D() {
        trackData = new double[NFV+1][NFT+1];
        resetIndices();        
    }
    
    public Object clone() {
        LagrangianParticle2D clone = null;
        try {
            clone = (LagrangianParticle2D) super.clone();
     ...
     */
    public static void setTracker(LagrangianParticleTracker2D lpt) {
        LagrangianParticle2D.lpt = lpt;
    }
    ...
    /**
     * Gets current (n) position vector as grid I,J values (0<I<L;0<J<M).
     * @return --double[2] vector with particle I,J as elements.
     */
    public double[] getIJ() {
    ...
    /**
     * Gets current IJK position as a String ("I,J").
     * @return --String representation of IJ position.
     */
    ...
    /**
     * Convenience method to set particle's intrinsic u,v.
     ...
     */
    public void setUV(double u, double v, int m) {
        setU(u,m);
        setV(v,m);
     }
