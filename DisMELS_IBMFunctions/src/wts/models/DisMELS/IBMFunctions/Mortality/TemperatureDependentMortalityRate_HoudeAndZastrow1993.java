...
/**
 * This class provides an implementation of a temperature-dependent mortality rate function
 * for feeding-stage larvae from Houde & Zastrow (1993).
 * Type: 
 *      mortality function
 * Parameters (by key):
 *      alpha - Double - mortality rate at T=0 (1/day).          Default value = 0.0149
 *      beta  - Double - linear coefficient in T (1/[day-degC]). Default value = 0.0129
 ...
 * Calculation:
 *      mortality_rate = Max[alpha+beta*T + stdv*N(0,1)),0];
 * 
...
public class TemperatureDependentMortalityRate_HoudeAndZastrow1993 extends AbstractIBMFunction {
    
    /** function classification */
    public static final String DEFAULT_type = "Mortality";
    /** user-friendly function name */
    public static final String DEFAULT_name = "Temperature-dependent mortality rate (Houde and Zastrow, 1993)";
    /** function description */
    public static final String DEFAULT_descr = "Temperature-dependent mortality rate with additive random noise from Houde and Zastrow (1993)";
    /** full description */
    public static final String DEFAULT_fullDescr = 
            "\n\t**************************************************************************"+
            "\n\t* This class provides an implementation of a temperature-dependent mortality rate function"+
            "\n\t* for feeding-stage larvae from Houde and Zastrow (1993)."+
            "\n\t* Type: "+
            "\n\t*      mortality function"+
            "\n\t* Parameters (by key):"+
            "\n\t*      alpha - Double - mortality rate at T=0 (1/day).          Default value = 0.0149"+
    ...
    public static final String PARAM_alpha = "mortality rate at T = 0 [1/day]";
    /** key to set rate parameter */
    public static final String PARAM_beta = "linear coefficient in T [1/(day-deg)]";
    ...
    private double alpha = 0.0149;
    /** value of linear coefficient parameter */
    private double beta = 0.0129;
    /** value of stdvRt parameter */
    private double stdvRt = 0;
   
    /** constructor for class */
    public TemperatureDependentMortalityRate_HoudeAndZastrow1993(){
    ...
    @Override
    public TemperatureDependentMortalityRate_HoudeAndZastrow1993 clone(){
        TemperatureDependentMortalityRate_HoudeAndZastrow1993 clone = new TemperatureDependentMortalityRate_HoudeAndZastrow1993();
