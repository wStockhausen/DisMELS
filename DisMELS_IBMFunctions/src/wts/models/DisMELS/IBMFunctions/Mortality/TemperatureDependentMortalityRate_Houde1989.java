 ...
 * for feeding-stage larvae from Houde (1989).
 * Type: 
 *      mortality function
 * Parameters (by key):
 *      alpha - Double - mortality rate at T=0 (1/day).          Default value  = 0.0256
 *      beta  - Double - linear coefficient in T (1/[day*degC]). Default value = 0.0123
 ...
 * Citation:
 * Houde, E.D. 1989. Comparative growth, mortality and energetic of marine fish larvae: 
 * temperature and implied latitudinal effects. Fish. Bull. 87: 471-495.
 */
@ServiceProviders(value={
    @ServiceProvider(service=IBMFunctionInterface.class)}
)
public class TemperatureDependentMortalityRate_Houde1989 extends AbstractIBMFunction {
    
    /** function classification */
    public static final String DEFAULT_type = "Mortality";
    /** user-friendly function name */
    public static final String DEFAULT_name = "Temperature-dependent mortality rate (Houde, 1989)";
    /** function description */
    public static final String DEFAULT_descr = "Temperature-dependent mortality rate with additive random noise from Houde (1989)";
    /** full description */
    ...
    private double alpha = 0.0256;
    /** value of linear coefficient parameter */
    private double beta = 0.0123;
    /** value of stdvRt parameter */
    private double stdvRt = 0;
   
    /** constructor for class */
    public TemperatureDependentMortalityRate_Houde1989(){
    ...
    @Override
    public TemperatureDependentMortalityRate_Houde1989 clone(){
        TemperatureDependentMortalityRate_Houde1989 clone = new TemperatureDependentMortalityRate_Houde1989();
