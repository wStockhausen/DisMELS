 ...
 */
public class HSMFunction_NetCDF_InMemoryBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class , wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemoryCustomizer.class ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_description] = new PropertyDescriptor ( "description", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getDescription", "setDescription" ); // NOI18N
            properties[PROPERTY_fullDescription] = new PropertyDescriptor ( "fullDescription", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getFullDescription", "setFullDescription" ); // NOI18N
            properties[PROPERTY_functionName] = new PropertyDescriptor ( "functionName", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getFunctionName", "setFunctionName" ); // NOI18N
            properties[PROPERTY_functionType] = new PropertyDescriptor ( "functionType", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getFunctionType", "setFunctionType" ); // NOI18N
            properties[PROPERTY_parameterNames] = new PropertyDescriptor ( "parameterNames", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getParameterNames", null ); // NOI18N
            properties[PROPERTY_subfunctionNames] = new PropertyDescriptor ( "subfunctionNames", wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "getSubfunctionNames", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_calculate0] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class.getMethod("calculate", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_calculate0].setDisplayName ( "" );
            methods[METHOD_clone1] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class.getMethod("clone", new Class[] {})); // NOI18N
            ...
            methods[METHOD_setParameterValue9] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.HSMs.HSMFunction_NetCDF_InMemory.class.getMethod("setParameterValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
