 ...
 */
public class PowerLawSwimmingSpeedFunctionBeanInfo extends SimpleBeanInfo {

    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( PowerLawSwimmingSpeedFunction.class , null );
