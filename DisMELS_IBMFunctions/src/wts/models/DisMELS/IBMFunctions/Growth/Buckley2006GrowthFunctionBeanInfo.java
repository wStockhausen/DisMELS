 ...
 */
public class Buckley2006GrowthFunctionBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.IBMFunctions.Growth.Buckley2006GrowthFunction.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_functionName] = new PropertyDescriptor ( "functionName", wts.models.DisMELS.IBMFunctions.Growth.Buckley2006GrowthFunction.class, "getFunctionName", null ); // NOI18N
        }
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_setParameterValue4] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.Growth.Buckley2006GrowthFunction.class.getMethod("setParameterValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
