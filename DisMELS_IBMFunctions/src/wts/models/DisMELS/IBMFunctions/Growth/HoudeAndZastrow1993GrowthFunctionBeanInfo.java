 ...
 */
public class HoudeAndZastrow1993GrowthFunctionBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_CSV] = new PropertyDescriptor ( "CSV", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getCSV", null ); // NOI18N
            properties[PROPERTY_CSVHeader] = new PropertyDescriptor ( "CSVHeader", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getCSVHeader", null ); // NOI18N
            properties[PROPERTY_description] = new PropertyDescriptor ( "description", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getDescription", null ); // NOI18N
            properties[PROPERTY_functionName] = new PropertyDescriptor ( "functionName", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getFunctionName", null ); // NOI18N
            properties[PROPERTY_functionType] = new PropertyDescriptor ( "functionType", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getFunctionType", null ); // NOI18N
            properties[PROPERTY_parameterNames] = new PropertyDescriptor ( "parameterNames", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getParameterNames", null ); // NOI18N
            properties[PROPERTY_subfunctionNames] = new PropertyDescriptor ( "subfunctionNames", wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "getSubfunctionNames", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_calculate0] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class.getMethod("calculate", new Class[] {java.lang.Object.class})); // NOI18N
            methods[METHOD_calculate0].setDisplayName ( "" );
            methods[METHOD_clone1] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class.getMethod("clone", new Class[] {})); // NOI18N
            ...
            methods[METHOD_setParameterValue7] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.Growth.HoudeAndZastrow1993GrowthFunction.class.getMethod("setParameterValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
