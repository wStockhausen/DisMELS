 ...
 */
public class VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayerCustomizer extends javax.swing.JPanel implements java.beans.Customizer {
    
    private VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer obj = null;;

    /**
     * Creates new customizer DielVerticalMigration_FixedDepthRangesCustomizer
     */
    public VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayerCustomizer() {
        initComponents();
    }
    
    @Override
    public void setObject(Object bean) {
        if (bean instanceof VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer){
            obj = (VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer) bean;
            setParameters();
        }
    }

    private void setParameters() {
        jtfMinDepth.setText(((IBMParameterDouble)obj.getParameter(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_minDepth)).getValueAsString());
        jtfMaxDepth.setText(((IBMParameterDouble)obj.getParameter(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_maxDepth)).getValueAsString());
        jtfMinDistOffBottom.setText(((IBMParameterDouble)obj.getParameter(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_minDistOffBottom)).getValueAsString());
        jtfRPW.setText(((IBMParameterDouble)obj.getParameter(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_rpw)).getValueAsString());
    }
    ...
    private void jtfRPWActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfRPWActionPerformed
        ...
        obj.setParameterValue(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_rpw, val);
    ...
    private void jtfMinDepthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfMinDepthActionPerformed
        ...
        Double val = Double.parseDouble(str);
        obj.setParameterValue(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_minDepth, val);
    ...
    private void jtfMaxDepthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfMaxDepthActionPerformed
        ...
        Double val = Double.parseDouble(str);
        obj.setParameterValue(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_maxDepth, val);
    ...
    private void jtfMinDistOffBottomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfMinDistOffBottomActionPerformed
        ...
        Double val = Double.parseDouble(str);
        obj.setParameterValue(VerticalMovement_FixedDepthRangeRelativeToSurfaceBoundaryLayer.PARAM_minDistOffBottom, val);
