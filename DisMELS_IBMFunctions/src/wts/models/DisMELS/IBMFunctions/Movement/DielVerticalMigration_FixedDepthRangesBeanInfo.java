 ...
 */
public class DielVerticalMigration_FixedDepthRangesBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( wts.models.DisMELS.IBMFunctions.Movement.DielVerticalMigration_FixedDepthRanges.class , DielVerticalMigration_FixedDepthRangesCustomizer.class ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_functionName = 0;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_functionName] = new PropertyDescriptor ( "functionName", wts.models.DisMELS.IBMFunctions.Movement.DielVerticalMigration_FixedDepthRanges.class, "getFunctionName", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( wts.models.DisMELS.IBMFunctions.Movement.DielVerticalMigration_FixedDepthRanges.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_calculate0] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.Movement.DielVerticalMigration_FixedDepthRanges.class.getMethod("calculate", new Class[] {java.lang.Object.class})); // NOI18N
            ...
            methods[METHOD_setParameterValue5] = new MethodDescriptor(wts.models.DisMELS.IBMFunctions.Movement.DielVerticalMigration_FixedDepthRanges.class.getMethod("setParameterValue", new Class[] {java.lang.String.class, java.lang.Object.class})); // NOI18N
