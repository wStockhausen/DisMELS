...
/**************************************************************************
* This class provides an implementation of a gaussian distribution for
...
public class GaussianSpawningFunction extends AbstractIBMFunction {
    
    /** function classification */
    public static final String DEFAULT_type = "Spawning";
    /** user-friendly function name */
    public static final String DEFAULT_name = "gaussian-type spawning season";
    /** function description */
    public static final String DEFAULT_descr = "gaussian-type spawning season";
    /** full description */
    public static final String DEFAULT_fullDescr = 
            "\n\t**************************************************************************"+
            "\n\t* This class provides an implementation of a gaussian distribution for spawning"+
    ...
    /** key to set midpoint parameter */
    public static final String PARAM_peakDOY = "peak of spawning season (day-of-year)";
    /** key to set width parameter */
    public static final String PARAM_width = "width of spawning peak (days)";
    ...
    public GaussianSpawningFunction(){
        super(numParams,numSubFuncs,DEFAULT_type,DEFAULT_name,DEFAULT_descr,DEFAULT_fullDescr);
        String key; 
        key = PARAM_on;       addParameter(key,Double.class, key);
        key = PARAM_off;      addParameter(key,Double.class, key);
        key = PARAM_peakDOY;  addParameter(key,Double.class, key);
        key = PARAM_width;    addParameter(key,Double.class, key);
        key = PARAM_randomize;addParameter(key,Double.class, key);
    }
    
    @Override
    public GaussianSpawningFunction clone(){
        GaussianSpawningFunction clone = new GaussianSpawningFunction();
        ...
        if (super.setParameterValue(param, value)){
            switch (param) {
                ...
                case PARAM_off:
                    ...
                    break;
                case PARAM_peakDOY:
                    peakDOY = MathFunctions.mod(((Double) value).doubleValue(),366.0);
                    break;
                case PARAM_width:
