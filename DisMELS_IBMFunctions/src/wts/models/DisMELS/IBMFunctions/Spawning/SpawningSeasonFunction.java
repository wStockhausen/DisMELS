...
public class SpawningSeasonFunction extends AbstractIBMFunction {
    ...
    @Override
    public SpawningSeasonFunction clone(){
        SpawningSeasonFunction clone = new SpawningSeasonFunction();
